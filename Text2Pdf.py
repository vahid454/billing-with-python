...
class PDFCreator(object):
    ...
    def __init__(self, args, margins):
        ...
        self.fontSize = 1.43*args.font_size
        if args.font not in ('Courier'):
            self.font = 'myFont'
            pdfmetrics.registerFont(TTFont('Verdana', args.font))
        else:
            self.font = args.font
...
file=args.filename;
NameOfFile=file.replace(".txt",".pdf")
args.output=NameOfFile
